...
const ACTIVE_STYLE = {
  color: "#fff",
  background: "linear-gradient(180deg, rgba(255,85,0,0.2), transparent), rgba(255,255,255,0.05)",
  boxShadow: "0 0 18px rgba(255,85,0,0.2), inset 0 0.5px 0 rgba(255,255,255,0.14)",
};
...
export default function Sidebar() {
  ...
  return (
    <aside
      className="shrink-0 flex flex-col h-full border-r border-white/[0.05] pb-3 transition-[width] duration-300"
      style={{
    ...
    >
      ...
      <div className="flex items-center h-12 px-2 shrink-0">
        <div className="w-10 h-10 shrink-0 flex items-center justify-center">
          <img src="./sc.png" alt="SoundCloud" className="w-7 h-7 object-contain" />
        </div>
        <span
          className="ml-1 text-white font-bold text-sm tracking-tight overflow-hidden whitespace-nowrap"
          style={{
      ...
      <div className="px-2 flex flex-col gap-0.5">
        <NavLink
          to="/settings"
          className="flex items-center h-10 rounded-xl text-white/45 hover:text-white/80 hover:bg-white/[0.05] transition-all"
        >
          <span className="w-10 shrink-0 flex items-center justify-center">
            <SettingsIcon />
          </span>
          <span
            className="text-[12.5px] font-medium overflow-hidden whitespace-nowrap"
            style={{
              maxWidth: collapsed ? 0 : "142px",
              opacity: collapsed ? 0 : 1,
              transition: LABEL_T,
        ...
        <button
          ...
          className="flex items-center h-10 rounded-xl text-white/45 hover:text-white/80 hover:bg-white/[0.05] transition-all cursor-pointer w-full"
        >
          <span className="w-10 shrink-0 flex items-center justify-center">
